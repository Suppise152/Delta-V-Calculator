...
const NODE_POSITIONS = {
    ...
    mun_intercept: { x: 360, y: 606 },
    mun_orbit: { x: 230, y: 606 },
    mun_land: { x: 95, y: 606 },
    mun_label: { x: 35, y: 606 },

    minmus_intercept: { x: 615, y: 606 },
    minmus_orbit: { x: 745, y: 606 },
    minmus_land: { x: 880, y: 606 },
    minmus_label: { x: 930, y: 606 },
