(function attachKsrssMapPositions(global) {
    const KSRSS_POSITIONS = {
        interplanetary: { x: -7, y: 488 },

        sun_orbit: { x: -345, y: 490 },
        sun_land: { x: -495, y: 490 },
        sun_label: { x: -555, y: 490 },

        mercury_intercept: { x: -175, y: 420 },
        mercury_orbit: { x: -315, y: 420 },
        mercury_land: { x: -445, y: 420 },
        mercury_label: { x: -540, y: 420 },

        venus_intercept: { x: -140, y: 350 },
        venus_orbit: { x: -300, y: 350 },
        venus_land: { x: -445, y: 350 },
        venus_label: { x: -530, y: 350 },

        earth_flyby: { x: -7, y: 580 },
        earth_orbit: { x: -7, y: 650 },
        earth_land: { x: -7, y: 720 },
        earth_label: { x: -25, y: 770 },

        moon_intercept: { x: -130, y: 615 },
        moon_orbit: { x: -240, y: 615 },
        moon_land: { x: -350, y: 615 },
        moon_label: { x: -415, y: 615 },

        mars_intercept: { x: -130, y: 200 },
        mars_orbit: { x: -330, y: 200 },
        mars_land: { x: -445, y: 200 },
        mars_label: { x: -515, y: 200 },

        phobos_intercept: { x: -230, y: 130 },
        phobos_orbit: { x: -330, y: 130 },
        phobos_land: { x: -400, y: 130 },
        phobos_label: { x: -480, y: 130 },

        deimos_intercept: { x: -230, y: 270 },
        deimos_orbit: { x: -330, y: 270 },
        deimos_land: { x: -400, y: 270 },
        deimos_label: { x: -480, y: 270 },

        vesta_intercept: { x: 10, y: 160 },
        vesta_orbit: { x: -200, y: 15 },
        vesta_land: { x: -380, y: 15 },
        vesta_label: { x: -460, y: 15 },

        ceres_intercept: { x: -70, y: 160 },
        ceres_orbit: { x: -200, y: 70 },
        ceres_land: { x: -380, y: 70 },
        ceres_label: { x: -460, y: 70 },
    ...
    global.DeltaVMapPositionData.ksrss = KSRSS_POSITIONS;
})(window);
